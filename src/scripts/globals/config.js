const CONFIG = {
  ...
  BASE_IMAGE_URL_SMALL_RES: 'https://dicoding-restaurant-api.el.r.appspot.com/images/small/',
  ...
  CACHE_NAME: 'LoveEat-WPA-v3.2', // new Date().toISOString()
  DATABASE_NAME: 'love-eat-database-v2',
  DATABASE_VERSION: 5,
